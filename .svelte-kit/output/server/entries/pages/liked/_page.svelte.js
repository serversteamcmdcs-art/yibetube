...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    t = translations[lang];
    head("ajgdzm", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>Liked Videos - VibeTube</title>`);
      });
    });
    $$renderer2.push(`<div class="app svelte-ajgdzm">`);
    Header($$renderer2, { user, onMenuClick: () => sidebarOpen = !sidebarOpen });
    $$renderer2.push(`<!----> `);
    Sidebar($$renderer2, { isOpen: sidebarOpen, user });
    $$renderer2.push(`<!----> <main${attr_class("svelte-ajgdzm", void 0, { "sidebar-open": sidebarOpen })}><div class="container"><h1 class="svelte-ajgdzm">${escape_html(t.liked)}</h1> `);
    {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="loading svelte-ajgdzm">${escape_html(t.loading)}</div>`);
    }
