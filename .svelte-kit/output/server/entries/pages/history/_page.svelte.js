  ...
  $$renderer.component(($$renderer2) => {
    ...
    head("1xl2tfr", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>Watch History - VibeTube</title>`);
      });
    });
    $$renderer2.push(`<div class="app svelte-1xl2tfr">`);
    Header($$renderer2, { user, onMenuClick: () => sidebarOpen = !sidebarOpen });
    $$renderer2.push(`<!----> `);
    Sidebar($$renderer2, { isOpen: sidebarOpen, user });
    $$renderer2.push(`<!----> <main${attr_class("svelte-1xl2tfr", void 0, { "sidebar-open": sidebarOpen })}><div class="container"><h1 class="svelte-1xl2tfr">${escape_html(t.history)}</h1> `);
    {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="loading svelte-1xl2tfr">${escape_html(t.loading)}</div>`);
    }
