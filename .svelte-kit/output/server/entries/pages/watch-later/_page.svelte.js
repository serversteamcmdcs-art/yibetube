...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    t = translations[lang];
    head("1bhu077", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>Watch Later - VibeTube</title>`);
      });
    });
    $$renderer2.push(`<div class="app svelte-1bhu077">`);
    Header($$renderer2, { user, onMenuClick: () => sidebarOpen = !sidebarOpen });
    $$renderer2.push(`<!----> `);
    Sidebar($$renderer2, { isOpen: sidebarOpen, user });
    $$renderer2.push(`<!----> <main${attr_class("svelte-1bhu077", void 0, { "sidebar-open": sidebarOpen })}><div class="container"><h1 class="svelte-1bhu077">${escape_html(t.watchLater)}</h1> `);
    {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="loading svelte-1bhu077">${escape_html(t.loading)}</div>`);
    }
